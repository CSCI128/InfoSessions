...
def get_image_of_the_day():
    ...
    # TODO Make API call to NASA's API
...
def download_image(image_url):
    ...
    Finally, the bytes of the content should be returned

    """

    # TODO Make API call to get the image

    # TODO Return the bytes stream of the respons's content
